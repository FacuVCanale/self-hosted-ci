...
- Pilot Action coordinator may use serialized Actions+Checks only if sandbox proves ownership; otherwise use an atomic Worker/Durable Object store before requiring `ci-gate`.
