...
PUBLIC_ARTIFACTS = (
    (
        "scripts/host/verify-wsl-jit-readiness.py",
    ...
    (
        "scripts/host/verify-live-artifact-contract.py",
    ...
    (
        "scripts/host/collect-wsl-jit-measurements.py",
    ...
    (
        "scripts/host/collect-health-snapshot.py",
    ...
    (
        "scripts/host/garm-cli-session.py",
    ...
    (
        "scripts/host/update-health-heartbeat.py",
    ...
    (
        "scripts/host/prepare-incus-runner-image.sh",
    ...
    (
        "scripts/host/build-repository-profile-image.sh",
    ...
    (
        "images/overworld-pr-v1/manifest.json",
    ...
    (
        "images/overworld-pr-v1/squid-build.conf",
    ...
    (
        "images/overworld-pr-v1/provision.py",
    ...
    (
        "images/overworld-pr-v1/verify.py",
    ...
    (
        ...
        "/usr/local/share/self-hosted-ci/images/overworld-pr-v1/profile-assets/next-font-google-mocked-responses.cjs",
        "0644",
        "public-config",
        "incus",
    ),
    (
        ...
        "/usr/local/share/self-hosted-ci/images/overworld-pr-v1/profile-assets/fonts/FragmentMono-OFL.txt",
        "0644",
        "public-config",
        "incus",
    ),
    (
        ...
        "/usr/local/share/self-hosted-ci/images/overworld-pr-v1/profile-assets/fonts/FragmentMono-Regular.ttf",
        "0644",
        "public-config",
        "incus",
    ),
    (
        ...
        "/usr/local/share/self-hosted-ci/images/overworld-pr-v1/profile-assets/fonts/Geist-OFL.txt",
        "0644",
        "public-config",
        "incus",
    ),
    (
        ...
        "/usr/local/share/self-hosted-ci/images/overworld-pr-v1/profile-assets/fonts/GeistMono-OFL.txt",
        "0644",
        "public-config",
        "incus",
    ),
    (
        ...
        "/usr/local/share/self-hosted-ci/images/overworld-pr-v1/profile-assets/fonts/GeistMono[wght].ttf",
        "0644",
        "public-config",
        "incus",
    ),
    (
        ...
        "/usr/local/share/self-hosted-ci/images/overworld-pr-v1/profile-assets/fonts/Geist[wght].ttf",
        "0644",
        "public-config",
        "incus",
    ),
    (
        ...
        "/usr/local/share/self-hosted-ci/images/overworld-pr-v1/profile-assets/fonts/README.md",
        "0644",
        "public-config",
        "incus",
    ),
    ...
    (
        "scripts/host/activate-garm-jit.sh",
    ...
    (
        "scripts/host/deactivate-garm-jit.sh",
    ...
    (
        "scripts/host/garm-jit-transaction-lib.sh",
    ...
    (
        "scripts/host/install-incus-garm-tls.sh",
    ...
    (
        "scripts/host/install-runner-network-runtime.sh",
    ...
    (
        "scripts/host/apply-runner-network-policy.sh",
    ...
    (
        "scripts/host/run-egress-proxies.sh",
    ...
    (
        "scripts/host/garm-callback-proxy.py",
    ...
    (
        "scripts/host/garm-allocation-broker.py",
    ...
    (
        "scripts/host/runner-job-started-hook.py",
    ...
    (
        "scripts/host/install-outbound-worker-runtime.py",
    ...
    (
        "scripts/host/jit-pilot-terminal-monitor.py",
    ...
    (
        "github_automation/runner_boundary.py",
    ...
    (
        "github_automation/runner_jit.py",
    ...
    (
        "github_automation/runner_jit_broker.py",
    ...
    (
        "github_automation/github_adapter.py",
    ...
    (
        "github_automation/check_delivery.py",
    ...
    (
        "github_automation/inventory.py",
    ...
    (
        "github_automation/coordinator.py",
    ...
    (
        "github_automation/outbound_worker.py",
    ...
    (
        "github_automation/worker_authority.py",
    ...
    (
        "github_automation/gatestore.py",
    ...
    (
        "github_automation/jit_pilot.py",
    ...
    (
        "github_automation/local_approval.py",
    ...
    (
        "github_automation/pilot_checks.py",
    ...
    (
        "templates/garm/outbound-worker.json.example",
    ...
    (
        "templates/garm/worker-app-authority.json.example",
    ...
    *(
    ...
    (
        "packaging/systemd/self-hosted-ci-boundary-verify.service",
    ...
    (
        "packaging/systemd/self-hosted-ci-garm.service",
    ...
    (
        "packaging/systemd/self-hosted-ci-network-policy.service",
    ...
    (
        "packaging/systemd/self-hosted-ci-egress-proxy.service",
    ...
    (
        "packaging/systemd/self-hosted-ci-allocation-broker.service",
    ...
    (
        "packaging/systemd/self-hosted-ci-outbound-worker.service",
    ...
    (
        "packaging/systemd/self-hosted-ci-health-heartbeat.service",
    ...
    (
        "packaging/systemd/self-hosted-ci-health-heartbeat.timer",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        for target, component in PINNED_BINARIES:
            ...
            info, data = (
                os.stat(installed, follow_symlinks=False),
        ...
        args.output_boundary.write_text(
